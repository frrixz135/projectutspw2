                    ...
                    <div class="homeslider">
                        <div class="content-slide">
                            <ul id="contenhomeslider">
                                <li><img alt="Funky roots" src="assets/mcom/assets/data/ip12.jpg" title="Funky roots" /></li>
                                <li><img alt="Funky roots" src="assets/mcom/assets/data/ip13.jpg" title="Funky roots" /></li>
                                <li><img  alt="Funky roots" src="assets/mcom/assets/data/ip14.jpg" title="Funky roots" /></li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="service ">
            <div class="col-xs-6 col-sm-3 service-item">
                ...
                <div class="info">
                    ...
                    <span>On order over Rp 3.000</span>
                </div>
            </div>
            <div class="col-xs-6 col-sm-3 service-item">
                <div class="icon">
