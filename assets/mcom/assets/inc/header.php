    ...
    <div class="top-header">
        <div class="container">
            <div class="nav-top-links">
                <a class="first-item" href="#"><img alt="phone" src="assets/mcom/assets/images/phone.png" />+62881387736881</a>
    ...
    <div class="container main-header">
        <div class="row">
            <div class="col-xs-12 col-sm-3 logo">
                <a href="index.php"><img alt="Soft Domain Host" src="assets/mcom/assets/inc/cucigudang.jpg" /></a>
            </div>
