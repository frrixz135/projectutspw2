                                                ...
                                                echo '
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 150px">
                                                            <input type="text" class="form-control" value="'.$price.'" readonly="readonly">Rp /Unit
                                                        </td>
                ...
                <div class="col-md-3">
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            ...
                            <h2 class="font-bold" >
                                Rp <span id="total-checkout"><?php echo $totalcheckOut;?></span>
                            </h2>
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content text-center">
                            ...
                            <h3><i class="fa fa-phone"></i> +6281387736881</h3>
                            <span class="small">
